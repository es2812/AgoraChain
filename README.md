...
2. [`deploy.sh`](https://github.com/es2812/AgoraChain/tree/master/composer-env/agora-network/dist/deploy.sh) installs and starts the `.bna` file of the specified version (1.0.1 recommended) and creates some sample participants and cards.
