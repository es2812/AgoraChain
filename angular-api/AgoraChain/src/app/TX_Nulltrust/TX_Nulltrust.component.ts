...
@Component({
  ...
  styleUrls: ['./TX_Nulltrust.component.css'],
...
export class TX_NulltrustComponent implements OnInit {
  ...
  constructor(private serviceTX_Nulltrust: TX_NulltrustService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceTX_Nulltrust.getAll()
    .toPromise()
    .then((result) => {
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceTX_Nulltrust.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceTX_Nulltrust.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
