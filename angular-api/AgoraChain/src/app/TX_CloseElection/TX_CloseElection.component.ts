...
@Component({
  selector: 'app-tx_closeelection',
  templateUrl: './TX_CloseElection.component.html',
  styleUrls: ['./TX_CloseElection.component.css'],
...
export class TX_CloseElectionComponent implements OnInit {
  ...
  constructor(private serviceTX_CloseElection: TX_CloseElectionService, fb: FormBuilder) {
  ...
  loadAll(): Promise<any> {
    const tempList = [];
    return this.serviceTX_CloseElection.getAll()
    .toPromise()
    .then((result) => {
  ...
  updateTransaction(form: any): Promise<any> {
    ...
    return this.serviceTX_CloseElection.updateTransaction(form.get('transactionId').value, this.Transaction)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
  ...
  deleteTransaction(): Promise<any> {
    ...
    return this.serviceTX_CloseElection.deleteTransaction(this.currentId)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
    })
